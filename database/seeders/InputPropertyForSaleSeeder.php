...
class InputPropertyForSaleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $screen1 = Screen::where('category_id', 5)->where('name_en', 'Basic Property Information')->first();
        $screen2 = Screen::where('category_id', 5)->where('name_en', 'Property Details')->first();
    ...
    private function inputsForPropertyDetails(): array
    {
        return [
            ...
            [
                'title_en' => 'Benefits', 'title_ar' => 'المزايا',
                'placeholder_en' => 'Select benefits', 'placeholder_ar' => 'حدد المزايا',
